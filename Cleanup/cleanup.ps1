<#
	...
	.DESCRIPTION
		...
		$SHARE
			|$SUBFOLDER
				|$SUBFOLDER1
					- Delete files with extension1 and older than limit1.
					- Delete files with extension2 ans older than limit2.
				|$SUBFOLDER2
					- Delete files with extension1 and older than limit1.
					- Delete files with extension2 ans older than limit2.
				|$SUBFOLDER3
					- Delete files with extension1 and older than limit3.
					- Delete files with extension2 ans older than limit3.
			|$SUBFOLDER	
